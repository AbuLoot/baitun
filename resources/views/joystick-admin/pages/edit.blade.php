...
@section('content')
  ...
  <form action="{{ route('pages.update', $page->id) }}" method="post">
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" id="summernote" name="short_description" rows="7" cols="10">{{ (old('short_description')) ? old('short_description') : $page->short_description }}</textarea>
    </div>
    <div class="form-group">
      <label for="content">Контент</label>
      <textarea class="form-control" id="summernote2" name="content" rows="5">{{ (old('content')) ? old('content') : $page->content }}</textarea>
    </div>
    <div class="form-group">
