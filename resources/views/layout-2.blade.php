...
<div class="side-navigation">
  <div class="menu">
    <ul>
      ...
      <li><a href="#">УСЛУГИ</a>
        <ul>
          <li><a href="zaga-construction.html">Сопровождение Документации</a></li>
          <li><a href="about-homepark.html">Архитектурное Проектирование</a></li>
          <li><a href="homepark-blocks.html">Строительство Объектов</a></li>
          <li><a href="homepark-blocks.html">Дизайн Интерьера</a></li>
        </ul>
      </li>
...
<nav class="navbar">
  <div class="container">
    <div class="upper-side">
      <div class="logo"> <a href="index.html"><img src="images/logo-4.png" alt="Image"></a> </div>
